...
SECRET_KEY = 'django-insecure-4-47!ov+r-@!j95++l)wv4o1%ep=04wt&m1^c4^(8y9)ems-sp'
...
GUIDDINI_APP_KEY = config('GUIDDINI_APP_KEY')
GUIDDINI_SECRET_KEY = config('GUIDDINI_SECRET_KEY')